...
if (isset($_GET['bID'])){
    $bid=$_GET['bID'];
    $select ="SELECT * From `product` left join `categories` on product.Cat_ID = categories.catID left join `local_brand` on product.lID = local_brand.lID WHERE product.lID=$bid";
...
<div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <div class="product-grid">
            ...
            <p class="title"> <a href=""> <?php echo $data['l_name']; ?> </a></p>
