...
@$uid = $_SESSION["uid"];
$select ="SELECT * From `product` left join `categories` on product.Cat_ID = categories.catID left join `local_brand` on product.lID = local_brand.lID WHERE `sID` is null";
...
<div class="form-outline">
    <input type="search" id="form1" name="searched" placeholder="Search For" class="form-control" />
  </div>
