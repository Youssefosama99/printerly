...
$select ="SELECT * From `product` left join `categories` on product.Cat_ID = categories.catID left join `local_brand` on product.lID = local_brand.lID  where categories.catID =1 and  `sID` is null";
