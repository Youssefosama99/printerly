...
if (isset($_GET['sID'])){
    $sid=$_GET['sID'];
    $select ="SELECT * From `product` left join `categories` on product.Cat_ID = categories.catID left join `supplier` on product.sID = supplier.sID WHERE product.sID=$sid";
