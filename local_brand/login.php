...
$select =" SELECT * FROM `local_brand` WHERE `l_email`='$email' AND `l_password`= '$pass'";
...
if($numrows > 0 && $_SESSION["payment"]=="true"){
  ...
  $_SESSION['localbrand']= $email;
  $bid =$_SESSION["bid"] = $fetch["lID"];

   header("location: ordersofusers.php");
}
elseif($_SESSION["payment"] =="false"){
  echo "<div style='margin-left: 670px ;' class='btn btn-danger'>You haven't paid yet</div>";

}
else{
  echo "<div style='margin-left: 650px;' class='btn btn-danger'>wrong E-mail or password</div>";
}
}
...
">
	<div class="infinity-container">
		...
		<div class="infinity-form-block">
			<div class="infinity-click-box text-center">Login as Local Brand</div>
