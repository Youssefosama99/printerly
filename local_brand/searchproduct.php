...
$select ="SELECT * From `product` left join `categories` on product.Cat_ID = categories.catID left join `supplier` on product.sID = supplier.sID WHERE `lID` is null AND `P_name` LIKE '%$searched%' OR `s_name` LIKE '%$searched%'";
...
<div class="prods">
<div class="input-group" style="margin-left : 580px;">
