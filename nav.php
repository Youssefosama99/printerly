<?php 
include '/xampp/htdocs/printerly/shared/config.php';
include '/xampp/htdocs/printerly/shared/header.php';
session_start();
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <?php   if(isset($_SESSION['supplier'])){ ?>
                <!-- <li class="nav-item">
                <a class="nav-link active" href="/printerly/e-learning.php" style="">e_learning</a>
              </li> -->
...
<li class="nav-item dropdown active" style="postion : absolute; left:670;">
