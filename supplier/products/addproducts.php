...
if(isset($_GET ['edit'])){
 ...
 if(isset($_POST['upd'])){
  ...
  $location = "/xampp/htdocs/printerly/images/".$image_name;
     ...
     header("location:/printerly/supplier/products/myproducts.php");
   }
...
<h1 class="text-center" style="color:white !important;">Add Product</h1>
<?php }?>
<?php  if($update){ ?>

<h1 class="text-center" style="color:white !important;">Update Product</h1>
<?php }?>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input  type="number" value="0<?php echo $discount ; ?>"  class="form-control" name="pdiscount" placeholder="Please enter Product price" >
