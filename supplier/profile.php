...
$sid = $_SESSION['sid'];
$select ="SELECT * FROM `supplier` WHERE sID=$sid ";
            ...
            <div class="card">
              <div class="rounded-top text-white d-flex flex-row" style="background-color: #f3eded; height:200px;">
                ...
                <img src="/printerly/images/<?php echo $fetch['photo']; ?>"
                    ...
                    <a type="button" href="./signup.php?edit=<?php echo $fetch['sID']; ?>" style="margin-top:170px; margin-left:-125px; height:40px; z-index: 2" class="btn btn-outline-dark text-center" data-mdb-ripple-color="dark"
                    >
                    Edit profile </a>
                </div>
                <div class="ms-3" style="margin-top: 130px;">
                  <h5 style="color: purple;"> <?php echo $fetch['s_name']; ?></h5>
              ...
              <div class="card-body p-4 text-black">
                ...
                <br>
                  <div class="p-4" style="background-color:purple; color: white;">
                    <div class="font-italic mb-1" >Name:  <?php echo $fetch['s_name']; ?></div>
                    <p class="font-italic mb-1">Phone: 0<?php echo $fetch['phone']; ?></p>
                    <p class="font-italic mb-0">Email: <?php echo $fetch['s_email']; ?></p>
                  </div>
                </div>
